...
Backend Boundary section explicitly allows (plus the handful of read-only helpers the probe needs -- get_parameter,
get_contact_list, create_device/mesh/etc., delete_device/mesh -- all top-level, documented DEVSIM Python API).
No AST match on `devsim._*`, `devsim.__internal*`, or any private/underscore-prefixed attribute is permitted.
...
ALLOWLIST = {
    ...
    "interface_equation", "solve", "get_node_model_values", "get_node_model_list", "get_contact_current",
    "get_contact_list", "get_device_list", "create_1d_mesh", "add_1d_mesh_line", "add_1d_contact", "add_1d_region",
