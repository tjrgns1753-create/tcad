# Tier 1-1 r3 -- 전체 현재 테스트 (baseline 120 + 신규)
...
## baseline에 없던 신규 실패 (120개 중, r3에서 새로 실패)
...
| 테스트 | 상태 | 초 |
|---|---|---:|
| test_measurement_canonical_state_gate_mock.py | PASS | 0.66 |
| test_measurement_entry_point_gate_mock.py | PASS | 0.91 |
| test_float32_boundary_snap_real.py | PASS | 3.67 |
| test_measurement_canonical_state_gate_real.py | PASS | 3.08 |
